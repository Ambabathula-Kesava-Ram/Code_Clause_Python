...
def addsongs():
    ...
    for s in temp_song:
        s = s.replace("C:/Users/Kesava Ram/OneDrive/Desktop/Internships/Code Clause Python/Music Player/Music/", "")
...
def Play():
    ...
    song = f'C:/Users/Kesava Ram/OneDrive/Desktop/Internships/Code Clause Python/Music Player/Music/{song}'
...
def Previous():
    ...
    temp2 = f'C:/Users/Kesava Ram/OneDrive/Desktop/Internships/Code Clause Python/Music Player/Music/{temp2}'
...
def Next():
    ...
    temp = f'C:/Users/Kesava Ram/OneDrive/Desktop/Internships/Code Clause Python/Music Player/Music/{temp}'
...
root=Tk()
root.title('Kesava Music player App ')
#initialize mixer 
mixer.init()
